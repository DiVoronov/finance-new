...
export const tickersChangeSlice = createSlice({
  name: 'tickersChange',
  initialState,
  reducers: {
    requestChanges: (state, action) => {
...
export const { requestChanges } = tickersChangeSlice.actions;

export const tickersChangeReducer = tickersChangeSlice.reducer;
